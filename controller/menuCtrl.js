app.controller("menuCtrl", function ($scope, services, $http, $location, $cookieStore, RESOURCES,menuService) {
    ...
    if(loggedInUser.identity.role==1){
      $scope.menuList = [
          ...
          {"Title": "Device Management", "Link": "/device/device_list", "icon": "fa fa-wrench", "active":"deactive"},
          {"Title": "Reports", "Link": "/report/report_list", "icon": "fa fa-file-text", "active":"deactive"},
          // {"Title": "Report Settings", "Link": "/setting/pdf_setting_list", "icon": "fa  fa-gear", "active":"deactive"},
          {"Title": "Sticker Management", "Link": "/sticker/filter", "icon": "fa fa-th", "active":"deactive"}
      ];
